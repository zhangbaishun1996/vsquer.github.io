...
/* 	this.canvansW = $('.bottomd ').outerWidth()-200;
	this.canVansH = $('#timeline').parent().height(); */
    this.timecell = options.init_cells;
    this.leftOfset = $('.boxcanvasd').offset().left;
...
TimeSlider.prototype.mousedownFunc = function(e){
    ...
    this.g_mousedownCursor = this.get_cursor_x_position(e)-this.leftOfset;//记住mousedown的位置
}
